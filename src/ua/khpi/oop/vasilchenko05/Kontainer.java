...
import static ua.khpi.oop.vasilchenko05.Functions.sortAlphabetical;
import static ua.khpi.oop.vasilchenko05.Functions.sortByLength;

/**
 * Contain elements in program.
 */
class Kontainer implements Iterable<String> {
    /**
    ...
    void lengthSorting(final int index) {
        array[index - 1] = sortByLength(array[index - 1]);
    }

    void alphabeticalSorting(final int index) {
        array[index - 1] = sortAlphabetical(array[index - 1]);
    }
